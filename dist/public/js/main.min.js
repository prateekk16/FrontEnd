...
Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var rn=e.jQuery,on=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=on),t&&e.jQuery===ie&&(e.jQuery=rn),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),$(function(){this.openNav=function(){document.getElementById("burger-nav").style.height="100%"},this.closeNav=function(){document.getElementById("burger-nav").style.height="0%"}}),function(){var e=angular.module("project",[]);e.controller("NavigationController",function(){var e=this;e.active="home",this.setActive=function(t){e.active=t},this.checkActive=function(t){return e.active===t}}),e.controller("FamilyController",function(){this.names=t,this.searchString=""}),e.filter("searchFor",function(){return function(e,t){if(!t)return e;var n=[];return t=t.toLowerCase(),angular.forEach(e,function(e){e.firstName.toLowerCase().indexOf(t)!==-1&&n.push(e)}),n}}),e.filter("maxAge",function(){return function(e,t){if(!t)return e;var n=[];return angular.forEach(e,function(e){e.age<=t&&n.push(e)}),n}});var t=[{firstName:"Prateek",lastName:"Singh",age:28},{firstName:"Mayank",lastName:"Singh",age:30},{firstName:"Sunakshi",lastName:"Singh",age:32},{firstName:"Rashmi",lastName:"Singh",age:56},{firstName:"Krishna",lastName:"Singh",age:61}]}();